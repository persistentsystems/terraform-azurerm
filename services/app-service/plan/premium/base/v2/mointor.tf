...
resource "azurerm_monitor_diagnostic_setting" "adminui_plan_diagnostic_setting" {

  name                        = "adminui-appserviceplan-logs"
...
resource "azurerm_monitor_diagnostic_setting" "adminui_plan_log_setting" {

  name                        = "adminui-appserviceplan-storage"
  target_resource_id          = azurerm_app_service_plan.app_service_plan.id
