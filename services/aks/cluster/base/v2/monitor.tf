...
resource "azurerm_monitor_diagnostic_setting" "patientmatch-aks_diagnostic_setting" {
  name                        = "${var.service_settings.name}-patientmatch-aks-logs"
...
resource "azurerm_monitor_diagnostic_setting" "patientmatch-aks_log_setting" {
  name                        = "${var.service_settings.name}-patientmatch-aks-storage"
  target_resource_id          = azurerm_kubernetes_cluster.cluster.id
