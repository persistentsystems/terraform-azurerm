...
locals {
  ...
  merged_service_settings = {
    ...
    patientmatch_virtual_network_subnet_id = var.service_settings.virtual_network_subnet_id
    patientmatch_restriction_name          = var.service_settings.restriction_name
    patientmatch_priority                  = var.service_settings.priority
    patientmatch_action                    = var.service_settings.action
